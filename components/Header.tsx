...
export default function Header() {
  return (
    <header className="navbar mx-1 w-auto justify-center border-b-2 border-base-300 dark:border-neutral md:mx-16 lg:mx-40">
      <div className="flex flex-1 items-center gap-2">
        ...
        <a
          ...
          className="badge badge-secondary badge-sm gap-0.5"
